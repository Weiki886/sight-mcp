...
**语言 / Language：** [中文](process.md) · English
...
- Related: [Issue #6](https://github.com/Weiki886/sight-mcp/issues/6),
  [v0.1.0 release notes](v0.1.0.en.md), [Host smoke procedure](host-smoke.en.md),
  [accepted local smoke record](smoke-record-v0.1.0-rc.en.md),
  [profile smoke record](profile-smoke-record-2026-09-01.en.md)
