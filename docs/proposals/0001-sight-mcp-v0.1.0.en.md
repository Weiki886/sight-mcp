...
**语言 / Language：** [中文](0001-sight-mcp-v0.1.0.md) · English
...
[the vision tool contract](../specs/vision-tool-contract.en.md).

The normative environment variables, defaults, URL policy, and validation rules are in
[the configuration specification](../specs/configuration.en.md).
...
The implementation must satisfy the controls in [the threat model](../security/threat-model.en.md),
...
[The test and delivery strategy](../testing/strategy.en.md) defines:
...
- ADR: required; see [ADR 0001](../adr/0001-runtime-and-architecture.en.md).
- Threat model: required; see [the v0.1.0 threat model](../security/threat-model.en.md).
